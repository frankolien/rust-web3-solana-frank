...
|----|---------------|-----------|:-------------|-------------|----------------|-------|-------|
| 0  | **Rust Fundamentals Bootcamp** | 30+ | - Variables & Mutability <br>- Data Types <br>- Functions <br>- Control Flow <br>- Ownership & Borrowing <br>- Structs & Enums <br>- Error Handling <br>- Collections <br>- Traits & Generics <br>- Iterators & Closures <br>- Lifetimes <br>- Modules & Cargo <br>- Macros | [![Github](https://img.shields.io/badge/launch-Github-181717.svg?logo=github&logoColor=white)](./chapter-0/README.md) | | | |
